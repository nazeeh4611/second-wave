...
function SocialMediaMarketing() {
  ...
  const features = [
    { 
      ...
      features: ['Content Calendar', 'Trend Analysis', 'Visual Content', 'Copywriting']
    },
    { 
      icon: <FiUsers />, 
      title: 'Community Management', 
      desc: 'Build and nurture engaged communities',
      features: ['Engagement', 'Moderation', 'Crisis Management', 'Community Building']
    },
    { 
      icon: <FiMessageCircle />, 
      title: 'Influencer Marketing', 
      desc: 'Partner with key voices in your industry',
      features: ['Influencer Outreach', 'Campaign Management', 'Performance Tracking', 'Partnerships']
    },
    { 
      icon: <FiShare2 />, 
      title: 'Viral Campaigns', 
      desc: 'Create shareable moments that spread',
      features: ['Campaign Strategy', 'Hashtag Creation', 'User Generated Content', 'Viral Optimization']
    }
  ];

  const platforms = ['Instagram', 'TikTok', 'Facebook', 'Twitter', 'LinkedIn', 'YouTube', 'Pinterest', 'Snapchat'];
    ...
    <div ref={pageRef} className="relative overflow-x-hidden bg-black pt-16 sm:pt-20">
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-6">
          ...
          <h1 className="social-hero-title font-black text-white mb-4 sm:mb-6 leading-none px-2" style={{ fontSize: 'clamp(2rem, 12vw, 6rem)', perspective: '1000px' }}>
            <span className="inline-block">Social Media</span>{' '}
            <span className="inline-block text-white/70">Marketing</span>
          </h1>
          
          <p className="social-hero-subtitle text-white/60 text-sm sm:text-base md:text-xl max-w-2xl mx-auto leading-relaxed px-4">
            Build thriving communities and drive engagement through strategic social media. Content that sparks conversations and turns followers into loyal customers.
          </p>
          
          <p className="text-white/40 text-xs sm:text-sm mt-4 font-medium tracking-wide">
            Fun · Engagement · Awareness
          </p>
        </div>

        <div className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1 sm:gap-2">
          <span className="text-[8px] sm:text-[10px] text-white/40 tracking-[0.3em] uppercase">ENGAGE</span>
      ...
      <section className="py-16 sm:py-20 bg-[#0a0a0a] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
            {[
              { count: 500, suffix: 'K+', label: 'Followers Grown', icon: <FiUsers /> },
              { count: 10, suffix: 'M+', label: 'Monthly Reach', icon: <FiShare2 /> },
              { count: 85, suffix: '%', label: 'Engagement Rate', icon: <FiHeart /> },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="font-black text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4">
              Social <span className="text-white/40">Services</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="social-card group relative overflow-hidden"
              >
          ...
          <div className="relative p-8 sm:p-12 md:p-16 rounded-3xl overflow-hidden bg-gradient-to-br from-gray-900 to-black">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-white/50 text-sm sm:text-base max-w-2xl mx-auto mb-8 leading-relaxed">
                Let's create engaging social media strategies that connect with your audience and drive real results.
              </p>
