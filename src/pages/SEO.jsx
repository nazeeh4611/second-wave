    ...
    <div ref={pageRef} className="relative overflow-x-hidden bg-black pt-16 sm:pt-20">
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4 sm:px-6">
          ...
          <h1 className="seo-hero-title font-black text-white mb-4 sm:mb-6 leading-none px-2" style={{ fontSize: 'clamp(2rem, 12vw, 6rem)', perspective: '1000px' }}>
            ...
            <span className="inline-block text-white/70">Optimization</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="font-black text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4">
              Comprehensive <span className="text-white/40">SEO</span>
            </h2>
      ...
      <section className="py-16 sm:py-20 bg-[#0a0a0a] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:g ap-8">
            {[
